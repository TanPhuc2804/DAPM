        ...
        <div className="flex flex-col pb-6 max-w-full w-[376px]">
          <div className="flex flex-col pb-1 w-full text-2xl max-w-[376px]">
            <div className="flex gap-10 justify-between items-center w-full">
              ...
              <div className="self-stretch my-auto font-semibold leading-none text-zinc-900">{total}</div>
            </div>
          ...
          <div className="flex gap-10 justify-between items-center mt-4 w-full text-3xl leading-none">
            ...
            <div className="self-stretch my-auto text-green-900">{total}</div>
          </div>
        </div>
        <button className="flex gap-3 justify-center items-center px-8 max-w-full text-2xl font-bold tracking-wide text-white uppercase bg-green-900 rounded leading-[56px] w-[376px] max-md:px-5">
