...
import ModalVouchers from '../../../../assets/Component/Layout/DefautLayout/Voucher/ModalVouchers';
function CartSummary({ cartItems }) {
    ...
    useEffect(() => {
        if (voucher.discount) {
            setPriceDiscount(total*( voucher.discount/100))
        } else {
            setPriceDiscount(0)
        }
    }, [voucher])
    ...
    return (
        <div className="flex flex-col ml-5 w-[31%] max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col justify-center items-center pb-6 mx-auto w-full bg-white rounded border border-gray-200 border-solid min-h-[471px] max-md:max-w-full">
                ...
                <div className="flex flex-col pb-6 max-w-full w-[376px]">
                    <div className="flex flex-col pb-1 w-full text-2xl max-w-[376px]">
                        ...
                        <div className="flex gap-10 justify-between items-center mt-3 w-full leading-none" onClick={() => setVisible(true)}>
            ...
            <ModalVouchers visible={visible} close={() => setVisible(false)} />
